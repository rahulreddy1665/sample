...
import "react-multi-carousel/lib/styles.css";
import Term from "../../assets/User/term.png";
...
const useStyles = createStyles((theme) => ({
  ...
  root: {
    ...
    // minHeight: '500px',
    backgroundImage: `linear-gradient(to bottom, black, rgba(255,255,255,0)),  url(${Term})`,
  ...
  return (
    <>
      ...
      <Container size="lg" pb={50} pt={30}>
        <LazyShow>
          <Text style={{ fontWeight: 700 }}>Terms And Condition</Text>
          <p>
