...
import Refund from "../../assets/User/refund.png";
import "react-multi-carousel/lib/styles.css";
...
const useStyles = createStyles((theme) => ({
  ...
  root: {
    ...
    // minHeight: '500px',
    backgroundImage: `linear-gradient(to bottom, black, rgba(255,255,255,0)),  url(${Refund})`,
  ...
  return (
    <>
      ...
      <Container size="lg" pb={50} pt={30}>
        <LazyShow>
          <Text style={{ fontWeight: 700 }}>Suspend & Refund</Text>
          <p>
