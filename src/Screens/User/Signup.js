  ...
  const handleRegister4 = (values) => {
    ...
    if (values.package_id !== "") {
      axios
        ...
        .then((response) => {
          console.log(response.data);
          if (response.data.success_payment === true) {
            setActive(2);
          } else {
  ...
  const SubmitImage = () => {
    ...
    axios
      .post(
        URL + "register7",
        {
          phone_number: form.values.phone_number.slice(
            form.values.phone_number.length - 10
          ),
          images: imagesArray,
        },
    ...
    <>
      ...
      <Container size="lg" p={20}>
        ...
        >
          ...
          >
            <Paper radius="sm" p={10} mt={5}>
              ...
              >
                ...
                >
                  <div style={{ width: "48%" }}>
                    ...
                    <PhoneInput
                      ...
                      onChange={(e) => {
                        console.log(e.slice(e.length - 10).length);
                ...
                {otpSetup == false ? (
                  <>
                    {form.values.phone_number.slice(
                      form.values.phone_number.length - 10
                    ).length === 10 ? (
                ...
                <Grid>
                  <Grid.Col span={4}>
                    <TextInput
                      ...
                      onBlur={(e) => handelCoupon(e.target.value)}
                      mb={10}
                    />
                  </Grid.Col>
                </Grid>
          ...
          <Stepper.Step label="Personal Details" allowStepSelect={active == 2}>
            <Paper radius="sm" p={10}>
              <form
          ...
          <Stepper.Step label="Upload Pictures" allowStepSelect={active == 3}>
                          ...
                          {(status) => (
                            <div style={{ pointerEvents: "none" }}>
                              ...
                              >
                                ...
                                files that are less than 10mb in size. This logo
                                will used for print invoice
                              </Text>
                            </div>
                          )}
                        </Dropzone>
