...
export default function Education() {
  ...
  useEffect(() => {
    // for fetching the data of education
    const fetchData = async () => {
      ...
      // For get all the education data list
      await axios
  ...
  const handleEducationdelete = (e) => {
    ...
    // Main axios part for deleting  education data
    axios
      .delete(URL + "education/" + e, config)
      .then((response) => {
  ...
  const handleEducationEdits = (values) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        data[edit_index].label = values.education;
  ...
  return (
    <div>
      ...
      <Drawer
        ...
        size={440}
      >
        {/* Form for adding new education name */}
      ...
      <Drawer
        ...
        size={440}
      >
        {/* Form for update the education name */}
        <form
